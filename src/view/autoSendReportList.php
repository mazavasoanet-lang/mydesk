...
$currentYear = date('Y',pq_strtotime(getSessionValue('weekImputationValidation')));
$currentMonth = date('m',pq_strtotime(getSessionValue('weekImputationValidation')));
...
$lastDay = lastDayofWeek(weekNumber($currentDay), date('Y',pq_strtotime($currentDay)));
