...
$hideClosedProjectConsolidation=RequestHandler::getValue("hideClosedProjectConsolidation");
...
<div id="imputListDiv" name="imputListDiv">
  ...
  <?php ConsolidationValidation::drawProjectConsolidationValidation($idProject,$idProjectType,$idOrganization,$year,$month,$hideClosedProjectConsolidation);?>
  </form>
</div>
