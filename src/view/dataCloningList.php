        ...
        <table width="100%">
          <tr>
            <td width="10%" nowrap="nowrap">
              <div id="dataCloningRequestorCount" style="font-weight:bold;" title="<?php echo $dataCloningCountTitle;?>">
                <?php echo $dataCloningCount;?>
              </div>
            </td>
            <td width="90%" nowrap="nowrap" style="padding-right:2%">
              <?php echo ($width>1200)?i18n("labelShowIdle"):i18n("labelShowIdleShort");?>
