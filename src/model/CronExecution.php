...
class CronExecution extends SqlElement {
  ...
  public static function drawCronExecutionDefintion($scope,$adminView=false) {
    ...
    if($scope!='disconnectAll' and $scope!='runConsistencyFix')echo "<br/>";
    if($scope!='disconnectAll' and $scope!='runConsistencyCheck')echo "<br/>";
    ...
    if(!$adminView){
      if($scope=='disconnectAll' or $scope=='runConsistencyFix' or $scope=='runConsistencyCheck')$adminView=true;
      $minutes=$splitCron[0];
      $hours=$splitCron[1];
