          ...
          <tr>
             ...
             <td>
               <textarea dojoType="dijit.form.Textarea" 
                ...
                maxlength="4000" 
                class="input"><?php echo pq_htmlspecialchars($workUnits->reference);?></textarea>   
             </td>
           </tr>
           <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
           <tr>
             ...
             <td>
                    ...
                    <textarea  style="width:<?php echo $detailWidth;?>px; height:<?php echo $detailHeight;?>px"
                               name="WUDescriptions" id="WUDescriptions"><?php echo pq_htmlspecialchars($workUnits->description);?></textarea>
             </td>
           </tr>
           <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
           <tr>
             ...
             <td>
              <input id="WUIncoming" name="WUIncoming" type="hidden" value=""/>
                    <textarea  style="width:<?php echo $detailWidth;?>px; height:<?php echo $detailHeight;?>px"
                    name="WUIncomings" id="WUIncomings"><?php echo pq_htmlspecialchars($workUnits->entering);?></textarea>
             </td>
          </tr>
          <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
          <tr>
             ...
             <td>
               <input id="WULivrable" name="WULivrable" type="hidden" value=""/>
                    <textarea style="width:<?php echo $detailWidth;?>px; height:<?php echo $detailHeight;?>px"
                    name="WULivrables" id="WULivrables"><?php echo pq_htmlspecialchars($workUnits->deliverable);?></textarea>
             </td>
           </tr>
           <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
          <tr>
           ...
           <table style="width:98%">
              ...
              <tr>
                ...
                <div dojoType="dijit.form.NumberTextBox" <?php echo $isReadOnly; ?> id="charge<?php echo $comp->id;?>" name="charge<?php echo $comp->id;?>" type="text" style="padding:0 !important;margin:0 !important; height:100% !important;width:100% !important;" class="input"  value="<?php if($mode=='edit'){echo Work::displayWork($tabCompValues[$comp->id]['charge']);} ?>">
              ...
              <tr>
                ...
                <td style="width:<?php echo $tdWitdh;?>%" class="assignData">
                <div dojoType="dijit.form.NumberTextBox" <?php echo $isReadOnly; ?> id="price<?php echo $comp->id;?>" name="price<?php echo $comp->id;?>" type="text" style="padding:0 !important;margin:0 !important; height:100% !important;width:100% !important;" class="input"  value="<?php if($mode=='edit'){echo $tabCompValues[$comp->id]['price'];} ?>"> 
                <?php echo $keyDownEventScript;?>
                </div>
                </td>
                <?php } ?>
              ...
              <tr>
                ...
                <td style="width:<?php echo $tdWitdh;?>%" class="assignData"> 
                <div dojoType="dijit.form.NumberTextBox" <?php echo $isReadOnly; ?> id="duration<?php echo $comp->id;?>" name="duration<?php echo $comp->id;?>" type="text" style="padding:0 !important;margin:0 !important; height:100% !important;width:100% !important;" class="input"  value="<?php if($mode=='edit'){echo $tabCompValues[$comp->id]['duration'];} ?>"> 
                <?php echo $keyDownEventScript;?>
                </div>
                 </td>
                <?php } ?>
