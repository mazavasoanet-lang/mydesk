            ...
            <table width="100%" align="center">
              <tr style="height:22px;">
                <td colspan="2" class="filterHeader"><?php echo i18n('storedFavoriteProjectList');?></td>
                  ...
                  <tr>
                    <td colspan="2">
                      <div id="listStoredFavoriteProjectList" name="listStoredFavoriteProjectList" dojoType="dijit.layout.ContentPane" region="center" style="width:100%;height:141px;overflow-y: auto;">
