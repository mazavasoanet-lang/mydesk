...
$isWorkPlan = (pq_substr($report->file, 0, 18) == 'globalWorkPlanning')?true:false;
?>
  <table>
    <tr>
      <td>
          ...
          <table width="100%" style="white-space:nowrap">
            ...
            <?php }?>
             <?php if ($yearSpinner != '') { 
              ...
              if ($yearSpinner == date('Y')-1){ $selectedYear='previous';}
              if ($yearSpinner == date('Y')+1){ $selectedYear='next';}
               ?>
            <tr>
              <td>
                ...
                <select dojoType="dijit.form.FilteringSelect" class="input roundedLeft"
                  ...
                  <option value="next"><?php echo i18n('setToNextYear');?></option>
                </select>
              </td>
            </tr>
            <?php }?>
            ...
            <tr>
              <td class="assignHeader"><?php echo pq_ucfirst(i18n('colFrequency'));?></td>
            </tr>
            <tr>
              <td></br></td>
            </tr>
            ...
            <tr>
              <td>
                <label for="sendTime" class="dialogLabel marginLabel" style="text-align:right;"><?php echo pq_ucfirst(i18n('hours')).Tool::getDoublePoint();?></label>
            ...
            <tr>
              <td>
                <label for="name" class="dialogLabel marginLabel" style="text-align:right;"><?php echo pq_ucfirst(i18n('colSendName')).Tool::getDoublePoint();?></label>
