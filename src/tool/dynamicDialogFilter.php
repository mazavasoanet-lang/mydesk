...
<table style="<?php if (isNewGui()) echo 'width:780px';?>">
    ...
    <tr>
      <td style="margin: 2px;"> 
        <div id='listFilterClauses' dojoType="dijit.layout.ContentPane" region="center" style="overflow-x: hidden; max-height:40vh; overflow-y:auto;"></div>
         ...
         <table width="100%" style="border: 1px solid grey;">
           ...
           <tr style="vertical-align: top;">
             ...
             <td style="width: <?php echo (isNewGui())?'197':'210';?>px;" >
               <div dojoType="dojo.data.ItemFileReadStore" jsId="attributeStore" url="../tool/jsonList.php?listType=empty&csrfToken=<?php echo getSessionValue('Token'); ?>" searchAttr="name" >
               </div>
               <select dojoType="dijit.form.FilteringSelect" 
               <?php echo autoOpenFilteringSelect();?>
             ...
             <td style="width: <?php echo (isNewGui())?'117':'110';?>px;">
               <div dojoType="dojo.data.ItemFileReadStore" jsId="operatorStore" url="../tool/jsonList.php?listType=empty&csrfToken=<?php echo getSessionValue('Token'); ?>" searchAttr="name" >
               </div>
               <select dojoType="dijit.form.FilteringSelect" 
               <?php echo autoOpenFilteringSelect();?>
    ...
    <tr style="height:32px">
      <td align="center">
        ...
        <button class="mediumTextButton" dojoType="dijit.form.Button" type="submit" id="dialogFilterSubmit" onclick="protectDblClick(this);selectFilter();validateLayoutListColumn();return false;">
