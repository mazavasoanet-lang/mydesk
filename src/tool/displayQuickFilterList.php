  ...
  <tr><td>
    <table style="width:100%">
     <br> 
      ...
      <tr style="height:37px;">
        <td colspan=2 style="width:25%;text-align:right;text-transform:lowercase;"><span class="nobr"><?php echo i18n("filterByTagsQuick");?>&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
			  <td style="width:10%;text-align:center;">
			  <?php  $paramDisplayByTags = SqlElement::getSingleSqlElementFromCriteria('Parameter', array('idUser'=>$user->id,'parameterCode'=>'displayByTagsList_'.$objectClass));
			  if($paramDisplayByTags->parameterValue == 'block'){ $paramDisplayByTags = 'on';}else{ $paramDisplayByTags='off'; }?>
			   <div id="filterByTagsSwitch" name="filterByTagsSwitch" class="colorSwitch" data-dojo-type="dojox/mobile/Switch" value="<?php if(!$comboDetail and sessionValueExists('displayByTagsListSwitch'.$objectClass)){ echo getSessionValue('displayByTagsListSwitch'.$objectClass); }else{ echo $paramDisplayByTags; }?>" leftLabel="" rightLabel="">
            <script type="dojo/method" event="onStateChanged" >
