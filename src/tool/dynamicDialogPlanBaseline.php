               ...
               if ($mode=='edit') echo 'readonly';?>
                ...
                class="input required" required >
                 ...
                 <script type="dojo/connect" event="onChange" args="evt">
                   ...
                   if (this.value == 0) {
                      url = '../tool/getSingleData.php?dataType=count&class=Baseline&param1=idProject&value1='+this.value+'&param2=baselineDate&value2=<?php echo date('Y-m-d');?>&param3=idUser&value3=<?php echo getSessionUser()->id;?>&csrfToken='+csrfToken
                   } else {
