...
$lv->startDate = ( new DateTime( pq_substr($_REQUEST['startDate'],0,15) ) ) -> format('Y-m-d');
$lv->startAMPM = $_REQUEST['startAMPM'];
$lv->endDate = ( new DateTime( pq_substr($_REQUEST['endDate'],0,15) ) ) -> format('Y-m-d');
...
if (pq_strpos($lvSaveResult,"OK") === false){
